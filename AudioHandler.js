...
var AudioHandler = (function() {
	...
	function loadSampleAudio() {
        ...
        var songList = [
			...
			{songURL: "Songs/ssshhhiiittt! - Dances.mp3", songName: "ssshhhiiittt! - Танцы"},
          ];
          
          var selectedSong = songList[Math.floor(Math.random()*songList.length)];
		  document.getElementById("songId").innerHTML = selectedSong.songName;
		// Load asynchronously
		var request = new XMLHttpRequest();
		request.open('GET', selectedSong.songURL, true);
